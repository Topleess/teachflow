# TeachFlow landing design

## Direction
Hybrid of **Editorial Human** and **Canvas Bold**: a calm premium editorial frame around a memorable collaborative lesson canvas.
...
## Visual system
- Paper: `#f5f1e8`; ink: `#191915`; ochre: `#dfa147`; green: `#6f9688`; coral: `#df654b`.
- Large neutral sans-serif typography with limited Georgia italic accents.
- Rounded editorial surfaces, restrained shadows, visible grid only in the lesson canvas.
- Motion is limited to button feedback and disabled under `prefers-reduced-motion`.
